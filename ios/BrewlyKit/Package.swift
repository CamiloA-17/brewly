...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "JournalFeature", dependencies: ["BrewlyDomain", "BrewlyDesignSystem"], resources: [.process("Resources")]),
        ...
        .testTarget(name: "JournalFeatureTests", dependencies: ["JournalFeature", "BrewlyDomain"]),
    ]
)
